...
4. ตอบเป็นภาษาไทยเสมอ ตรงประเด็น — ถ้าเป็นรายการ/ระเบียบหลายข้อ ให้ตอบครบทุกข้อที่เกี่ยวข้องใน Context ห้ามตัดเหลือบางข้อ
5. ถ้า Context มีข้อมูลเป็นลำดับหรือรายการ ให้ตอบตามลำดับนั้นเสมอ ห้ามสลับลำดับ และห้ามละข้อ
6. คำถามเกี่ยวกับวัน/วันที่/ปฏิทินปัจจุบัน (เช่น "วันนี้วันอะไร" "พรุ่งนี้วันอะไร" "วันที่เท่าไหร่") ถ้า Context ไม่ได้ระบุวันนั้นชัดเจน ให้ตอบ "ไม่พบข้อมูล" — ห้ามอนุมานจากตารางเวลาทำงาน เช่น "จันทร์-ศุกร์"
7. ห้ามสร้างข้อเท็จจริงใหม่จากคำที่พบบางส่วนในเอกสาร หากเอกสารไม่ได้ตอบคำถามนั้นโดยตรง
"""